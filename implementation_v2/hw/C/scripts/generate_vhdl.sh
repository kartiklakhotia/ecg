...
AaLinkExtMem .Aa/band_pass_filter.aa .Aa/result_buffer.aa .Aa/best_fit.aa .Aa/beat.aa .Aa/derivative.aa .Aa/frontend.aa .Aa/hermite_fitter.aa .Aa/moving_average.aa .Aa/qrs_peak_detect.aa Aa/utils.aa Aa/ajit_fpu.aa  | vcFormat > .Aa/ecg.linked.aa
