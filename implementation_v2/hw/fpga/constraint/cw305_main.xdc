...
set_property -dict { PACKAGE_PIN N13    IOSTANDARD LVCMOS33 } [get_ports { CLK100MHZ }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets U_clk_wiz_0/inst/clk_out1]

####### USB Connector
#clk checking
set_property PACKAGE_PIN A13 [get_ports clk_debug1]
set_property PACKAGE_PIN C11 [get_ports clk_debug2]
set_property PACKAGE_PIN C16 [get_ports clklock]
set_property PACKAGE_PIN D13 [get_ports clk_debug3]
...
set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS33 } [get_ports { RsRx }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN C13    IOSTANDARD LVCMOS33 } [get_ports { RsTx }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
