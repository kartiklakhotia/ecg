...
read_vhdl -library work ../vhdl/basys3_top.cw305.vhdl
read_verilog ../verilog/cw305_usb_reg_fe.v
read_verilog ../verilog/cw305_top.v

############# CONSTRAINT FILE ###########
read_xdc ../constraint/cw305_main.xdc
...
############### SYNTHESIZE ##############
synth_design -fsm_extraction off -flatten_hierarchy none -top cw305_top -part xc7a100tftg256-2
