...
#
# Generated by Vivado on Sat Nov 07 16:51:08 IST 2020
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/madhav/ecg/implementation_v2/hw/basys3/ip/managed_ip_project/managed_ip_project.cache/compile_simlib/modelsim"
  fi
